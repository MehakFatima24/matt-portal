...
! function(a, b) {
    ...
    var i = function() {
        ...
        j = function(b, c) {
             ...
             this.viewMode = this.o.startView, this.o.calendarWeeks && this.picker.find("tfoot .today, tfoot .clear").attr("colspan", function(a, b) {
     return parseInt(b) + 1
 }), this._allow_update = !1,
 this.setNewClass(this.o.newClass),this.setStartDate(this._o.startDate), this.setEndDate(this._o.endDate), this.setDaysOfWeekDisabled(this.o.daysOfWeekDisabled), this.setDatesDisabled(this.o.datesDisabled), this.fillDow(), this.fillMonths(), this._allow_update = !0, this.update(), this.showMode(), this.isInline && this.show()
        };
    j.prototype = {
        constructor: j,
...
/** This method is used to add an additional class 
* to the date picker, provided by the option newClass
**/
setNewClass:function(nameclass){
this.picker.addClass(nameclass); 
},
/**This method is used to add a class a
* class to the dates that fall in a particular range between
* the srange i.e. start range & erange i.e. end range
**/
InRange:function(c,srange,erange){
if(srange && erange)
{ 
...
return false;
        ...
        getClassNames: function(b) {
            var c = [],
                ...
                g = new Date;
		if(this.InRange(b,this.o.startRange,this.o.endRange)){
		c.push("SelectedR");		
		};
    ...
    var n = a.fn.datepicker.defaults = {
            ...
            multidate: !1,
            multidateSeparator: ",",
	    /**This property is used to add a new class to the datepicker object**/
	    newClass:'',
	    /**This property is used to select the start of a range**/
	    startRange:'',
	    /**This property is used to select the end of a range**/
	    endRange:'',
            orientation: "auto",
            rtl: !1,
            startDate: -1 / 0,
